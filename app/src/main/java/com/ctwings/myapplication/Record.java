...
public class Record {
    ...
    public Record(int record_id, String person_mongo_id, String record_person_rut, String record_type, long record_date, int record_sync, String record_license_plate) {
        this.record_id = record_id;
        ...
        this.record_date = record_date;
        this.record_sync = record_sync;
        this.record_license_plate = record_license_plate;
    }
    ...
    public String getRecord_license_plate() {
        return record_license_plate;
    }

    public void setRecord_license_plate(String record_license_plate) {
        this.record_license_plate = record_license_plate;
    }
}